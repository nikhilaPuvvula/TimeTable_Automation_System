...
class Example(QMainWindow):
    ...
    def initUI(self):
        ...
        startAction.setStatusTip('Start solving process')
        ...
        # Set up menu bar with custom stylesheet
        menubar = self.menuBar()

        # Add menu actions
        fileMenu = menubar.addMenu('&Click Here')
        fileMenu.addAction(openAction)
        fileMenu.addAction(startAction)
        fileMenu.addAction(inputAction)
        fileMenu.addAction(exitAction)

        # Apply styles for hover and click effects
        ...
        palette = QPalette()
        palette.setColor(QPalette.Window, QColor(255, 239, 213))  # Light peach color
        self.setPalette(palette)

        # Global variable for professor name
        global professor
        professor = ''

        # Set window geometry and center it
        self.setGeometry(0, 0, 800, 600)  # Set initial window size
        self.setWindowTitle('Time Table Scheduling By Genetic Algorithm')
        self.centerWindow()
        self.show()
    ...
    def drawProfessor(self, qp):
        ...
        GROUP_CELL_WIDTH = 110
        GROUP_CELL_HEIGHT = 80

        GROUP_MARGIN_WIDTH = 75
        GROUP_MARGIN_HEIGHT = 60
